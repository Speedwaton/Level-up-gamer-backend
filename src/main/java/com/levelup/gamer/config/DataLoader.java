...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (!userRepository.findByCorreo("admin@levelupgamer.com").isPresent()) {
    ...
    private void loadAdminUser() {
        User admin = new User();
        admin.setRun("11111111"); // 8 dígitos sin guión
        admin.setCorreo("admin@levelupgamer.com");
        ...
        admin.setDireccion("Av. Level Up Gamer #123");
        admin.setEsAdmin(true);
        admin.setDescuento(0);
